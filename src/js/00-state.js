  ...
  // Economy nav group (Data Tracker + Job Displacement) hidden 2026-08-10 at the
  // team's request. TO SHOW IT AGAIN: set this to true and rebuild (python3 build.py).
  // One flag drives both the nav group's visibility (70-render.js) and its route
  // guards (40-router.js); nothing else needs editing to restore it.
